...
<head>
    ...
    <meta name="description" content="ИП Пронькина контакты">
...
<body>
    ...
    <div class="containers">
        <div class="contacts">
            <div class="two">
                <div class="one_text">Контакты</div>
            </div>
        </div>
    </div>
    <div class="wrapper">
        <div class="wrapper_cont">
            <div class="plus_icon"><img width="70px" height="70px"  src="image/map.ico"></div>
            <div class="plus_text">
                <div class="plus_zag">Наш адрес</div>
                <div class="plus_opis">680020, г. Хабаровск, ул. Уссурийская, д. 7</div>
            </div>
        </div>

        <div class="wrapper_cont">
            <div class="plus_icon"><img width="70px" height="70px"  src="image/clock.ico"></div>
            <div class="plus_text">
                <div class="plus_zag">Время работы</div>
                <div class="plus_opis">680020, г. Хабаровск, ул. Уссурийская, д. 7</div>
            </div>
        </div>

        <div class="wrapper_cont">
            <div class="plus_icon"><img width="70px" height="70px"  src="image/email.ico"></div>
            <div class="plus_text">
                <div class="plus_zag">Электронный адрес</div>
                <div class="plus_opis">Natalya.Pronkina@bk.ru</div>
            </div>
        </div>

        <div class="wrapper_cont">
            <div class="plus_icon"><img width="70px" height="70px"  src="image/phone.ico"></div>
            <div class="plus_text">
                <div class="plus_zag">Телефон</div>
                <div class="plus_opis">+7 (909) 840-16-47</div>
            </div>
        </div>
    </div>
    <footer>
